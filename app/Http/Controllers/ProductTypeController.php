...
class ProductTypeController extends Controller
{
    ...
    public function postThem(Request $req)
    {
        ...
        $producttype->id_category=$req->danhmuc;

        $category = Category::find($req->danhmuc);
    ...
    public function getSua($id)
    {
        ...
        $category = Category::all();
        return view('admin.ProductType.sua',['producttype'=>$producttype,'category'=>$category]);
    }
